...
df = pd.read_csv('/mount/src/genai-gemini-learning/stock_list1.csv')  #data is taken from NSE https://www.nseindia.com/market-data/securities-available-for-trading
